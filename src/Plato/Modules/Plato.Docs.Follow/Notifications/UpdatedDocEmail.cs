...
namespace Plato.Docs.Follow.Notifications
{
    ...
    public class UpdatedDocEmail : INotificationProvider<Doc>
    {
        ...
        public async Task<ICommandResult<Doc>> SendAsync(INotificationContext<Doc> context)
        {
            ...
            if (!context.Notification.Type.Name.Equals(EmailNotifications.UpdatedDoc.Name, StringComparison.Ordinal))
            {
                return null;
            }
            ...
            // Get email template
            const string templateId = "UpdatedDoc";
