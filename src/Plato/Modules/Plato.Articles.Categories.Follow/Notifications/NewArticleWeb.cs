...
namespace Plato.Articles.Categories.Follow.Notifications
{

    public class NewArticleWeb : INotificationProvider<Article>
    {
        ...
        public async Task<ICommandResult<Article>> SendAsync(INotificationContext<Article> context)
        {
            ...
            if (!context.Notification.Type.Name.Equals(WebNotifications.NewArticle.Name, StringComparison.Ordinal))
            {
                return null;
            }
            ...
            var userNotification = new UserNotification()
            {
                ...
                Message = S["An article has been posted within a category your following"],
