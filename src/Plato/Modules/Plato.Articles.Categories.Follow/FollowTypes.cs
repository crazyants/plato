    ...
    public class FollowTypes : IFollowTypeProvider
    {
        ...
        public static readonly FollowType Category =
            new FollowType(
                "ArticleCategory",
                "Follow Category",
                "Follow this category to get notified when new articles are posted within this category",
                "Unsubscribe",
                "You are following this category and will be notified when new articles are posted, click to unsubscribe",
        ...
        public static readonly FollowType AllCategories =
            new FollowType(
                ...
                "Unsubscribe",
                "You are following all categories and will be notified when new articles are posted, click to unsubscribe",
