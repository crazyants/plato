...
{
    public class QuestionSpamWeb : INotificationProvider<Question>
    {
        ...
        public async Task<ICommandResult<Question>> SendAsync(INotificationContext<Question> context)
        {
            ...
            if (!context.Notification.Type.Name.Equals(WebNotifications.QuestionSpam.Name, StringComparison.Ordinal))
            {
                return null;
            }
            ...
            var userNotification = new UserNotification()
            {
                ...
                Message = S["A question has been detected as SPAM!"],
                Url = url,
