            ...
            _breadCrumbManager.Configure(builder =>
            {
                ...
                else
                {
                    builder.Add(S["Categories"], categories => categories
                        .Action("Index", "Admin", "Plato.Questions.Categories", new RouteValueDictionary { ["Id"] = 0 })
                        .LocalNav()
                    );
                    foreach (var parent in parents)
                    {
                        if (parent.Id != id)
                        {
                            builder.Add(S[parent.Name], categories => categories
                                .Action("Index", "Admin", "Plato.Questions.Categories", new RouteValueDictionary { ["Id"] = parent.Id })
                                .LocalNav()
                            );
                        }
                        else
