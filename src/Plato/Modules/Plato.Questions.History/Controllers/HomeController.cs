...
namespace Plato.Questions.History.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        async Task<ICommandResultBase> ApplyLatestHistoryPoint(Question entity, Answer reply)
        {
        ...
        async Task<ICommandResultBase> ResetEditDetails(Question entity, Answer reply, IUser user)
        {
