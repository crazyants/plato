...
namespace Plato.Questions.Tags.ViewProviders
{
    public class AnswerViewProvider : BaseViewProvider<Answer>
    {
        ...
        public override Task<IViewProviderResult> BuildDisplayAsync(Answer comment, IViewProviderContext updater)
        {
            return Task.FromResult(default(IViewProviderResult));
        }

        public override Task<IViewProviderResult> BuildIndexAsync(Answer comment, IViewProviderContext updater)
        {
            return Task.FromResult(default(IViewProviderResult));
        }
        ...
        public override async Task<IViewProviderResult> BuildUpdateAsync(Answer comment, IViewProviderContext context)
        {
