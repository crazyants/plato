...
namespace Plato.Questions.Follow.Subscribers
{
    public class FollowSubscriber : IBrokerSubscriber
    {
        ...
        private async Task<Plato.Follows.Models.Follow> FollowCreated(Plato.Follows.Models.Follow follow)
        {
            ...
            if (!follow.Name.Equals(FollowTypes.Question.Name, StringComparison.OrdinalIgnoreCase))
            {
                return follow;
            }
            ...
            if (updatedTopic != null)
            {
                ...
                await _reputationAwarder.AwardAsync(Reputations.NewFollow, follow.CreatedUserId, "Followed a question");
            }
        ...
        private async Task<Plato.Follows.Models.Follow> FollowDeleted(Plato.Follows.Models.Follow follow)
        {
            ...
            if (updatedTopic != null)
            {
                ...
                await _reputationAwarder.RevokeAsync(Reputations.NewFollow, follow.CreatedUserId, "Unfollowed a question");
            }
