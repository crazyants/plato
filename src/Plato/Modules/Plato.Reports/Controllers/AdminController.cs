...
namespace Plato.Reports.Controllers
{
    public class AdminController : Controller, IUpdateModel
    {
        ...
        private readonly IViewProviderManager<PageViewsReport> _pageViewsViewProvider;
        ...
        public AdminController(
            ...
            IViewProviderManager<PageViewsReport> pageViewsViewProvider)
        {
        ...
        public async Task<IActionResult> PageViews(ReportIndexOptions opts, PagerOptions pager)
        {
            ...
            // Return view
            return View((LayoutViewModel)await _pageViewsViewProvider.ProvideIndexAsync(new PageViewsReport(), this));
