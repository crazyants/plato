...
namespace Plato.Stars.Controllers
{
    ...
    public class StarController : BaseWebApiController
    {
        ...
        public async Task<IActionResult> Post([FromBody] Star follow)
        {
            ...
            var existingStar = await _starStore.SelectFollowByNameThingIdAndCreatedUserId(
                follow.Name,
                follow.ThingId,
                user.Id);
        ...
        public async Task<IActionResult> Delete([FromBody] Star follow)
        {
            ...
            var existingFollow = await _starStore.SelectFollowByNameThingIdAndCreatedUserId(
                follow.Name,
                follow.ThingId,
                user.Id);
