...
{
    public class ArticleSpamEmail : INotificationProvider<Article>
    {
        ...
        public async Task<ICommandResult<Article>> SendAsync(INotificationContext<Article> context)
        {
            ...
            if (!context.Notification.Type.Name.Equals(EmailNotifications.ArticleSpam.Name, StringComparison.Ordinal))
            {
                return null;
            }
            ...
            // Get email template
            const string templateId = "NewArticleSpam";
