...
namespace Plato.Issues.Subscribers
{

    public class IssueCommentSubscriber<TEntityReply> : IBrokerSubscriber where TEntityReply : class, IEntityReply
    {
