...
namespace Plato.Entities
{
    ...
    public class Migrations : BaseMigrationProvider
    {
        ...
        private ICollection<string> v_1_0_8()
        {
            ...
            // Update entities & entity replies to support IsStaff fields
        ...
        private ICollection<string> v_1_0_9()
        {
            ...
            // Add Entities and EntityReply indexes
        ...
        private ICollection<string> v_1_1_0()
        {
            ...
            // Add entity data and entity reply data indexes
            ...
            using (var builder = _schemaBuilder)
            {
                ...
                builder.IndexBuilder.CreateIndex(new SchemaIndex()
                {
                    TableName = entityReplyData.Name,
                    Columns = new string[]
                    {
                        "ReplyId",
                        "CreatedUserId",
        ...
        private ICollection<string> v_1_1_1()
        {
