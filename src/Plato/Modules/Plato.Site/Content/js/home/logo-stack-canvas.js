$(function (win, doc, $) {
    ...
    $('[data-provide="logo-stack"]').each(function () {
        init($(this)[0]);
    });
    ...
    function init(elCanvas) {
        ...
        var scene = (() => {
            ...
            for (i = 4; i > 0; i--) {
                p += 1;
                var newInstance = mesh.createInstance("i" + i);
            ...
            var camera = new win.BABYLON.ArcRotateCamera('camera', 0, Math.PI * 3 / 4, 13, torus, scene, true);
