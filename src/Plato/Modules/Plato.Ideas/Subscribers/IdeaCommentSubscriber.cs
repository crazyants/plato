...
namespace Plato.Ideas.Subscribers
{
    ...
    public class IdeaCommentSubscriber<TEntityReply> : IBrokerSubscriber where TEntityReply : class, IEntityReply
    {
        ...
        private async Task<TEntityReply> EntityDetailsUpdater(TEntityReply reply)
        {
            ...
            var details = entity.GetOrCreate<IdeaDetails>();
            ...
            entity.AddOrUpdate<IdeaDetails>(details);
