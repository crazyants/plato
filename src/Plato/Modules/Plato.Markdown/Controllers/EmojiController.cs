...
{
    public class EmojiController : BaseWebApiController
    {
        ...
        private static List<Emoji> _emots = null;
        ...
        public Task<IActionResult> Get()
        {
            ...
            if (_emots == null)
            {
                _emots = new List<Emoji>();
                foreach (var item in EmojiToUnicodeDefault)
                {
                    _emots.Add(new Emoji()
                    {
                        Key = item.Key,
                        Value = item.Value
                    });
