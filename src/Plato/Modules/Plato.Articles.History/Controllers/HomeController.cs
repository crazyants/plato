...
namespace Plato.Articles.History.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        async Task<ICommandResultBase> ApplyLatestHistoryPoint(Article entity, Comment reply)
        {
        ...
        async Task<ICommandResultBase> ResetEditDetails(Article entity, Comment reply, IUser user)
        {
