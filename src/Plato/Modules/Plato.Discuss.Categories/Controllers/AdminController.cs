            ...
            _breadCrumbManager.Configure(builder =>
            {
                ...
                else
                {
                    builder.Add(S["Categories"], c => c
                        .Action("Index", "Admin", "Plato.Discuss.Categories", new RouteValueDictionary { ["Id"] = 0 })
                        .LocalNav()
                    );
                    foreach (var parent in parents)
                    {
                        if (parent.Id != id)
                        {
                            builder.Add(S[parent.Name], channel => channel
                                .Action("Index", "Admin", "Plato.Discuss.Categories", new RouteValueDictionary { ["Id"] = parent.Id })
                                .LocalNav()
                            );
                        }
                        else
