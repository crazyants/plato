    ...
    public class UserRepository : IUserRepository<User>
    {
        ...
        public async Task<User> InsertUpdateAsync(User user)
        {
            ...
            var userId = await InsertUpdateInternal(
                ...
                user.IsStaff,
                user.IsStaffUpdatedUserId,
                user.IsStaffUpdatedDate,
                user.IsBanned,
        ...
        private async Task<int> InsertUpdateInternal(
            ...
            bool isStaff,
            int isStaffUpdatedUserId,
            DateTimeOffset? isStaffUpdatedDate,
            bool isBanned,
            ...
            using (var context = _dbContext)
            {
                ...
                userId = await context.ExecuteScalarAsync<int>(
                    ...
                    new IDbDataParameter[]
                    {
                        ...
                        new DbParam("Biography", DbType.String, 150, bio.ToEmptyIfNull()),
                        new DbParam("Location", DbType.String, 100, location.ToEmptyIfNull()),
                        ...
                        new DbParam("IsStaff", DbType.Boolean, isStaff),
                        new DbParam("IsStaffUpdatedUserId", DbType.Int32, isStaffUpdatedUserId),
                        new DbParam("IsStaffUpdatedDate", DbType.DateTimeOffset, isStaffUpdatedDate),
