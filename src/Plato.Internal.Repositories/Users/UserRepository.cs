    ...
    public class UserRepository : IUserRepository<User>
    {
        ...
        public async Task<User> InsertUpdateAsync(User user)
        {
            ...
            var userId = await InsertUpdateInternal(
                ...
                user.IsBlackListed,
                user.IsWhiteListed,
                user.BlackListedExpiryDate,
                user.WhiteListedExpiryDate,
                (short)user.UserType,
                user.CreatedUserId,
                user.CreatedDate,
                user.ModifiedUserId,
        ...
        private async Task<int> InsertUpdateInternal(
            ...
            bool isBlackListed,
            bool isWhiteListed,
            DateTimeOffset? blackListedExpiryDate,
            DateTimeOffset? whiteListedExpiryDate,
            short userType,
            int createdUserId,
            ...
            IEnumerable<UserData> data)
        {
            ...
            using (var context = _dbContext)
            {
                ...
                userId = await context.ExecuteScalarAsync<int>(
                    ...
                    isBlackListed,
                    isWhiteListed,
                    blackListedExpiryDate,
                    whiteListedExpiryDate,
                    userType,
                    createdUserId,
