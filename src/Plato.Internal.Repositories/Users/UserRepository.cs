            ...
            IEnumerable<UserData> data)
        {
            ...
            using (var context = _dbContext)
            {
                ...
                userId = await context.ExecuteScalarAsync<int>(
                    ...
                    bio.ToEmptyIfNull().TrimToSize(255),
                    location.ToEmptyIfNull().TrimToSize(255),
                    url.ToEmptyIfNull().TrimToSize(255),
                    visits,
                    ...
                    signatureHtml.ToEmptyIfNull(),
                    isSpam,
                    isSpamUpdatedUserId,
                    isSpamUpdatedDate,
                    isVerified,
                    isVerifiedUpdatedUserId,
                    isVerifiedUpdatedDate,
                    isBanned,
                    isBannedUpdatedUserId,
                    isBannedUpdatedDate,
                    isBannedExpiryDate,
                    userType,
                    createdUserId,
